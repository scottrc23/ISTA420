...
select orderdate, shippeddate, julianday(shippeddate) -julianday(orderdate) as lag from orders order by lag desc limit 10;
...
select productname, productid, unitprice*unitsinstock as total_on_hand from products order by productname;
